...
- <b id="EKS">Create EKS Cluster on AWS (Master machine)</b>
  ...
  - AWSCLI should be configured (<a href="https://github.com/Shubhamharanale7/DevOps-Tools-Installations/blob/main/AWSCLI/AWSCLI.sh">Setup AWSCLI</a>)
  ```bash
  ...
  - Install **kubectl** (Master machine)(<a href="https://github.com/Shubhamharanale7/DevOps-Tools-Installations/blob/main/Kubectl/Kubectl.sh">Setup kubectl </a>)
  ```bash
  ...
  - Install **eksctl** (Master machine) (<a href="https://github.com/Shubhamharanale7/DevOps-Tools-Installations/blob/main/eksctl%20/eksctl.sh">Setup eksctl</a>)
  ```bash
...
- <b id="Jenkins-worker">Setting up jenkins worker node</b>
  ...
  - Configure AWSCLI (<a href="https://github.com/Shubhamharanale7/DevOps-Tools-Installations/blob/main/AWSCLI/AWSCLI.sh">Setup AWSCLI</a>)
  ```bash
  sudo su
  ```
  ```bash
...
docker run -itd --name SonarQube-Server -p 9000:9000 sonarqube:community  #Recommended to use
```
#
